...
// ilmoitukset.map(async (ilmoitus) => ({

//   kohde: await ilmoitus.findElement(testIdIs("kohde")).then(getText),
//   ilmoittaja: await ilmoitus.findElement(testIdIs("tekijä")).then(getText),
//   lähiosoite: await ilmoitus
//     .findElements(testIdIs("lähiosoite"))
//     .then(getOptionalText),
//     postitoimipaikka,
//     maa,
//     puhelin,
//     email,
